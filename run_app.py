...
# Versi ini memakai source Python FINAL, bukan file .pyd, agar build EXE
# tidak terkunci pada Python 3.14 dan logika Steel clamp dapat diperbarui.
# Perbaikan icon:
...
try:
    ...
    raise SystemExit(
        'Gagal memuat modul Kalashnikova_BOQ_Split_FINAL.py.\n'
